...
export default function VeiculoForm({ params }: VeiculoFormProps) {
  ...
  const modelosFiltrados = selectedMarcaId 
    ? modelos.filter(m => m.marcas_veiculos_id === selectedMarcaId)
    : modelos
                  ...
                  <Select
                    ...
                    onValueChange={(value) => {
                      ...
                      if (veiculo.modelos_veiculos_id > 0) {
                        ...
                        if (modeloAtual && modeloAtual.marcas_veiculos_id !== marcaId) {
                  ...
                  >
                    ...
                    <SelectContent>
                      {modelosFiltrados.map((modelo) => {
                        // Se não há marca selecionada, mostrar "Marca - Modelo"
                        // Se há marca selecionada, mostrar apenas "Modelo"
                        const displayName = selectedMarcaId 
                          ? modelo.nome 
                          : `${modelo.marca?.nome || 'Marca N/A'} - ${modelo.nome}`
