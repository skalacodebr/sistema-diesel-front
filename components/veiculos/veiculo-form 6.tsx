...
export default function VeiculoForm({ params }: VeiculoFormProps) {
  ...
  // Efeito para carregar modelos quando uma marca é selecionada
  useEffect(() => {
    if (selectedMarcaId) {
              ...
              <div className="space-y-4">
                ...
                {selectedModel && (
                  <div className="space-y-2">
                    <Label>Informações do Modelo</Label>
                    <div className="p-3 bg-gray-50 rounded-md">
                      <p className="text-sm"><strong>Marca:</strong> {marcas.find(m => m.id === selectedModel.marca_veiculo_id)?.nome}</p>
