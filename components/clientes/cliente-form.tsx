...
interface ClienteFormProps {
  params: {
    slug: string
    action: string // "novo" or cliente ID for editing
  }
}
...
export default function ClienteForm({ params }: ClienteFormProps) {
  ...
  const clienteId = params.action !== "novo" ? Number(params.action) : null
  ...
  const initializeForm = async () => {
    ...
    try {
      ...
      // Load options
      await Promise.all([
        loadGruposClientes(token),
        loadTiposPessoa(token),
        loadIndicadorIe(token),
      ])

      // If editing, load the cliente data
      if (clienteId) {
        await loadCliente(clienteId, token)
        setIsEditing(true)
      }
    } catch (error) {
  ...
  const loadGruposClientes = async (token: string) => {
    try {
  ...
  const loadCliente = async (id: number, token: string) => {
    try {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isEditing && clienteId) {
        await updateCliente(clienteId, cliente, token)
        toast({
          title: "Cliente atualizado com sucesso!",
          description: "As alterações foram salvas.",
        })
      } else {
        await createCliente(cliente, token)
        toast({
      ...
      router.push(`/${params.slug}/dashboard/clientes`)
    } catch (error) {
          ...
          <TabsContent value="basic" className="mt-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="grupos_clientes_id">Grupo de Cliente</Label>
                    <Select
                      value={cliente.grupos_clientes_id?.toString() || ""}
                      onValueChange={(value) => handleInputChange("grupos_clientes_id", value ? Number(value) : undefined)}
                    >
                      <SelectTrigger>
                  ...
                  <div>
                    ...
                    <Select
                      value={cliente.tipo_pessoa_id?.toString() || ""}
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    id="consumidor_final"
                    checked={cliente.consumidor_final || false}
                    onCheckedChange={(checked) => handleInputChange("consumidor_final", checked)}
                  />
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Select
                      value={cliente.indicador_ie_id?.toString() || ""}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      type="number"
                      value={cliente.inscricao_suframa || ""}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="contribuinte"
                      checked={cliente.contribuinte || false}
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="produtor_rural"
                      checked={cliente.produtor_rural || false}
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="isento_icms"
                      checked={cliente.isento_icms || false}
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="isento_ipi"
                      checked={cliente.isento_ipi || false}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="isento_iss"
                      checked={cliente.isento_iss || false}
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="isento_pis"
                      checked={cliente.isento_pis || false}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="isento_cofins"
                      checked={cliente.isento_cofins || false}
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="isento_ii"
                      checked={cliente.isento_ii || false}
