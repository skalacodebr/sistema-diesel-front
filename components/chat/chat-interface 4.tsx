...
export default function ChatInterface({ params }: ChatInterfaceProps) {
  ...
  useEffect(() => {
    ...
    const userStr = localStorage.getItem("sistema_diesel_user")
    ...
    if (userStr) {
      try {
        ...
        console.log("Current user loaded:", usuario)
      } catch (error) {
                          ...
                          <div className="flex flex-col max-w-[70%]">
                            ...
                            >
                              ...
                              <p className="text-xs opacity-50 mt-1">
                                {isCurrentUser ? "Você" : mensagem.remetente?.nome} (ID: {mensagem.remetente_id})
                              </p>
